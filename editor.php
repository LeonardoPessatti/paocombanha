        ...
        <body>
            <form method="post">
                ...
                <div id="inputs">
                    ...
                    <a class = "btn" href= "login.php?logout=true">Logout</a>
                </div>

                <div id="info">     
                    <div id="timer"> </div>
                    <p>Autor <?php echo $_SESSION['sechon'][id].': '.$_SESSION['sechon'][user]; ?></p>
                </div>
            </form>
        </body>
    </html>
