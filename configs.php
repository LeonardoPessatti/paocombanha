                ...
                <div class="row center">
                        <form  id="formMail" name="formMail" method="post" > action="http://www.jsdb.com.br"
                                <h1>Entre em contato</h1>
                                                        <input placeholder="Nome do site" name="nome" id="nome" type="text" class="validate" required="required">
                                                        <input placeholder="E-mail do adminsitrador" name="emailadm" id="emailadm" type="email" class="validate" required="required">
                                                        <input placeholder="E-mail para contato" name="email" id="email" type="email" class="validate" required="required">
...
$submit == $_POST['submit'];
$conteudo = 'Enviado por ' . $nome . ', email: ' . $email . ', รกs ' . date("H:i:s") . '<br><br>' . $msg;
